...
class TestBaseLoadFromFile(unittest.TestCase):
    ...
    def test_load_from_file_first_rectangle(self):
        ...
        self.assertEqual(str(rectangle1), str(loaded_rectangles[0]))
    ...
    def test_load_from_file_second_rectangle(self):
        ...
        Rectangle.save_to_file([rectangle1, rectangle2])
        loaded_rectangles = Rectangle.load_from_file()
        self.assertEqual(str(rectangle2), str(loaded_rectangles[1]))
    ...
    def test_load_from_file_first_square(self):
        ...
        self.assertEqual(str(square1), str(loaded_squares[0]))
    ...
    def test_load_from_file_second_square(self):
        ...
        Square.save_to_file([square1, square2])
        loaded_squares = Square.load_from_file()
        self.assertEqual(str(square2), str(loaded_squares[1]))
